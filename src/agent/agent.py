...
class CustomAgent(Agent):
    ...
    # NOTE: Uncomment below function if you want the custom finish tool to behave exactly like finish tool by setting conversation status to finished inside agent's step function instead of doing this inside the Tool's executor.
